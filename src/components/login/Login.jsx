        ...
        <>
            <div className="divbody text-center">
                <main className="form-signin w-100 m-auto">
                    <form className="p-5">
                        <img src="https://getbootstrap.com/docs/5.2/assets/brand/bootstrap-logo.svg" alt="" className="mb-4" width="72" height="57"/>
                        ...
                        <div className="form-floating">
                            <input
                                ...
                                id="usuario"
                            />
                            <label htmlFor="usuario" className="custom-control">Usuario</label>
                        </div>
                        ...
                        <div className="form-floating">
                            <input
                                ...
                                id="clave"
                            />
                            <label htmlFor="clave" className="custom-control">Clave</label>
                        </div>
