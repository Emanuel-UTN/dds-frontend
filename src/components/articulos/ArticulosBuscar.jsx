...
export default function ArticulosBuscar({ Nombre, setNombre, Activo, setActivo, Buscar, Agregar}) {
    return (
        <form action="" className="FormBusqueda">
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-sm-8 col-md-4">
                        <input type="text" className="form-control" value={Nombre} onChange={(e) => setNombre(e.target.value)} maxLength="55" autoFocus/>
                    </div>
                    <div className="col-sm-4 col-md-2">
                        <label className="col-form-label">Activo: </label>
                    </div>
                    <div className="col-sm-8 col-md-4">
                    <select className="form-control" value={Activo} onChange={(e) => setActivo(e.target.value)}>
                        <option value={""}></option>
